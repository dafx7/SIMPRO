...
export default function ProposalTable({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-gray-500">{total} proposal ditemukan</div>
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan={showSubmitter ? 6 : 5} className="p-12 text-center">
                  ...
                  <p className="text-gray-400">Tidak ada proposal ditemukan</p>
                </td>
              </tr>
            ) : (
              proposals.map((p) => (
                <tr key={p.id} className="border-b hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-3 text-gray-600 text-xs">{p.jurusan}</td>
